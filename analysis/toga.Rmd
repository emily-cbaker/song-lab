...
The help desk seems to think it's a problem with how I'm specifying the nodes and tasks per node but that's either not the problem or my syntax is incorrect. Awaiting another response from IT.
