...
order_levels <- c("Lepidoptera", "Orthoptera", "Hemiptera", "Phasmatodea", "Neuroptera", "Ephemeroptera", "Plecoptera", "Mantodea", "Blattodea")
order_colors <- c("#c5cafb", "#abdafc", "#d0f0c0", "#effeee", "#f9d7e9", "#f9f8d7", "#fac8a5", "#c4fcae", "#ccc0ba")
