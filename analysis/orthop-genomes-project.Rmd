...
# Hemiptera                              
"Balanococcus diminutus", "Nilaparvata lugens", "Placoccus citri", "Rhopalosiphum maidis", 

# Lepidoptera
"Spodoptera frugiperda", "Plutella xylostella", "Pieris rapae", "Bicyclus anyana", "Ostrinia nubilalis", "Vaneaa cardui", "Pieris brassicae", "Pararge aegeria", "Aricia agestis", "Cydia fagiglandana", "Nymphalis io", 
...
Order = c("Orthoptera","Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera",
          ...
          "Lepidoptera", "Lepidoptera", "Lepidoptera", "Lepidoptera", "Lepidoptera", "Lepidoptera", "Lepidoptera", "Lepidoptera", "Lepidoptera",              "Lepidoptera", "Lepidoptera", 
...
# Hemiptera
"New Zealand flax mealybug", "Brown planthopper", "Citrus mealybug", "Corn leaf aphid",

# Lepidoptera
"Fall armyworm", "Diamondback moth", "Cabbage white", "Squinting bush brown", "European corn borer", "Painted Lady", "Large cabbage white", "Speckled wood butterfly", "Brown argus", "Beech moth", "European peacock butterfly",
...
# Hemiptera
"313.1 Mb", "1.1 Gb", "403.6 Mb", "326 Mb",

# Lepidoptera
"383.9 Mb", "323.3 Mb", "256.4 Mb","457.2 Mb", "495.5 Mb", "424.8 Mb", "292.3 Mb", "516.6 Mb", "435.3 Mb", "555.1 Mb", "384.2 Mb",
...
# Hemiptera
"United Kingdom", "Wuhan, China", "United Kingdom", "Ithaca, NY",

# Lepidoptera
"Australia", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "West Salton Forest, Scotland", "Romania", "United Kingdom", "United Kingdom",
...
# Data for the table
data <- data.frame(
  Order = c("Orthoptera", "Hemiptera", "Lepidoptera", "Phasmatodea", "Neuroptera", "Ephemeroptera", "Plecoptera", "Mantodea", "Blattodea"),
  Total_num_assemblies = c("28", "214", "2304", "21", "11", "10","18", "8", "14"),
  Num_chrom_length_assemblies = c("11", "74", "580", "4", "5", "3", "7",  "6", "1"),
  Number_annotated = c("6", "195", "43", "1", "1", "2", "0",  "0", "2")
)
...
data <- data.frame(
  Species = c(
  # Orthoptera  
  "Schistocera gregaria","Schistocera americana","Schistocera nitens", "Schistocera cancellata", "Schistocera serialis cubense", "Schistocerca   piceifrons", 
  ...
  Order = c(
    "Orthoptera","Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera", "Orthoptera", "Blattodea", "Hymenoptera"),

  BUSCO_Analysis = c(
    # Orthoptera
    "96%", "96.6%", "96.4%", "96.3%", "96.8%", "94.8%",
  ...
  Genome_Size = c(
    # Orthoptera
    "8.7 Gb", "9 Gb", "8.8 Gb", "8.5 Gb", "9.1 Gb", "8.7 Gb",
  ...
  Genes_Annotated = c(
    # Orthoptera
    "99,467", "81,274", "72,560", "103,533", "75,810", "96,806",
  ...
  Protein_Coding = c(
    # Orthoptera
    "19,799", "17,662", "17,500", "16,907", "17,237", "17,490", 
...
# Define the factor levels and corresponding colors for Order column
order_levels <- c("Orthoptera", "Blattodea", "Hymenoptera")
order_colors <- c("#abdafc", "#ccc0ba", "#E46FD5")
...
# Select the Species column
data <- data[c("Species", "Order", "BUSCO_Analysis", "Genome_Size", "Genes_Annotated", "Protein_Coding", "NCBI_link")]
...
kable(data, "html", escape = FALSE, caption = "") %>%
  ...
  add_header_above(c(" " = 1, "Species of Interest & Outgroups Information" = 6))
```
