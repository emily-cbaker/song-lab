...
When I tried to run the script, he noticed that the jobs weren't taking up any memory on the cluster while they were running, so the script isnt actually doing anything. He did say we would probably need to run the pipeline on the big nodes due to the amount of memory they need to run. The command to do this is 
